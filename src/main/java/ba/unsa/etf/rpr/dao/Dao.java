...
import ba.unsa.etf.rpr.exceptions.OnlineShopExceptions;
...
public interface Dao<T> {
     ...
     */
    T getById(int id) throws OnlineShopExceptions;
     ...
     */
    T add(T item) throws OnlineShopExceptions;
