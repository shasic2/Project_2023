...
public abstract class AbstractDao<T extends Idable> implements  Dao<T> {
    ...
    public T getById(int id) throws HealthyShopException {
        return executeQueryUnique("SELECT * FROM "+this.tableName+" WHERE id = ?", new Object[]{id});
    }
    public List<T> getAll() throws HealthyShopException {
        return executeQuery("SELECT * FROM "+ tableName, null);
    }


    public void delete(int id) throws HealthyShopException {
    ...
    public T add(T item) throws HealthyShopException{
    ...
    public T update(T item) throws HealthyShopException{
        Map<String, Object> row = object2row(item);
    ...
    public List<T> executeQuery(String query, Object[] params) throws HealthyShopException {
        try {
     ...
     * @return Object
     * @throws HealthyShopException in case when object is not found
     */

    private T executeQueryUnique(String query, Object[] params) throws HealthyShopException {
        List<T> result = executeQuery(query, params);
        if (result != null && result.size() == 1){
            return result.get(0);
        }else{
            throw new HealthyShopException("Object not found");
        }
    }
